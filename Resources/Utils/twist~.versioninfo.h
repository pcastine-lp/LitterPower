...
#define LPobjID			17590
#define LPobjName		lp.twist~
...
#define LPobjStage			develStage						// Apple #defined build stage
...
#define LPobjDescription	Chebyshev-based waveshaping
