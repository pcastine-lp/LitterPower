/*
	...
	Contains:	Resources for Max/MSP external object sss~.
	...
	Change History (most recent first):
         ...
         <8>     10Ð2Ð06    pc      Update "bug fix" to reflect updated MachineKharma()
         <7>     21Ð1Ð04    pc      Go to final status.
         <6>     14Ð1Ð04    pc      Modify for Rez/RC compatibility
         <5>    6Ð7Ð2003    pc      Bump revision to final. Use STR# resource for Object List
                                    categories.
         <4>  30Ð12Ð2002    pc      Restore definition of LP_objStarter, mistakenly deleted.
		                            (Underscore inserted above for the convenience of our
									sort-of-lame script generating the versioninfo.h file)
...
#define LPobjID			17496
#define LPobjName		"lp.sss~"
...
#define LPobjDescription	"""Pink"" (1/f^2) noise (Voss/Gardner algorithm)"
