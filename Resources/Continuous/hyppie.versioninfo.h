...
#define LPobjID			17514
#define LPobjName		lp.hyppie
...
#define LPobjDescription	Generate random numbers from a hyperbolic cosine or hyperbolic secant distribution
